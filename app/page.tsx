...
import { SuccessMessage, ErrorMessage } from '@/components/layout/mensages';
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      <footer className="bg-[#FFEED3] py-4">
        <div className="flex justify-center">
          <img src="/img/Patrocinadores.png" alt="Patrocinadores" className="w-full sm:w-3/4 md:w-1/2 lg:w-1/3 h-auto object-contain" />
        </div>
      </footer>

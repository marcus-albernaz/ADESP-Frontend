...
export default function EditarPrato() {
  const [nome, setNome] = useState("Prato de exemplo");
  const [restaurante, setRestaurante] = useState("Restaurante A");
  const [tipoPrato, setTipoPrato] = useState("restaurante");
      ...
      <div className="flex flex-col px-5 py-6 max-w-4xl mx-auto w-full">
        <div className="flex items-center gap-3 mb-6">
          ...
          <motion.h1
            ...
            {...fadeUpTitle}
          >
            {userRole === "jurado" ? "Ver Prato" : "Editar Prato"}
          </motion.h1>
